...
export function DatePicker({
  ...
  // Función para manejar la selección de fecha y cerrar el popover
  const handleSelect = (selectedDate: Date | undefined) => {
    // Usar setDate si está disponible, de lo contrario usar onDateChange
    if (setDate) {
  ...
  return (
    <div className="relative">
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent className="w-auto p-0" align="start" side="bottom" sideOffset={5} style={{ zIndex: 9999 }}>

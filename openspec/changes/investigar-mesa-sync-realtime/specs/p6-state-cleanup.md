# Delta for State and Data Layer Cleanup (P6) — investigar-mesa-sync-realtime
...
#### Scenario: R6-01-S1 — Each store has independent state
...
#### Scenario: R6-01-S2 — `usePOSStore` is deleted
...
#### Scenario: R6-02-S1 — First load uses useQuery
...
#### Scenario: R6-02-S2 — Realtime event invalidates query cache
...
#### Scenario: R6-03-S1 — Legacy service deleted
...
#### Scenario: R6-05-S1 — models.ts deleted, index.ts is sole source

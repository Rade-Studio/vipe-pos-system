# Delta for Printer Listener Reliability (P5) — investigar-mesa-sync-realtime
...
#### Scenario: R5-01-S1 — Requirements file enables reproducible env
...
#### Scenario: R5-02-S1 — Service-role token passes Realtime auth
...
#### Scenario: R5-02-S2 — Anon key rejected by local stack
...
#### Scenario: R5-03-S1 — Duplicate broadcast does not re-print
...
#### Scenario: R5-03-S2 — After TTL, same invoice can print again
...
#### Scenario: R5-04-S1 — UTF-8 used when printer supports it
...
#### Scenario: R5-04-S2 — Spanish chars survive encoding
...
#### Scenario: R5-05-S1 — Shared renderer produces same output in web and Python
